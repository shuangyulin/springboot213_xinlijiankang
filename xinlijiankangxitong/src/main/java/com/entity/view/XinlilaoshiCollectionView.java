...
public class XinlilaoshiCollectionView extends XinlilaoshiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 类型的值
		*/
		private String xinlilaoshiCollectionValue;
	...
	public XinlilaoshiCollectionView(XinlilaoshiCollectionEntity xinlilaoshiCollectionEntity) {
		try {
			...
			* 获取： 类型的值
			*/
			public String getXinlilaoshiCollectionValue() {
				return xinlilaoshiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setXinlilaoshiCollectionValue(String xinlilaoshiCollectionValue) {
				this.xinlilaoshiCollectionValue = xinlilaoshiCollectionValue;
			}
